...
class Generator:
    ...
    def __init__(self, 
        ...
        self.MIN_COEFFICIENT_VALUE_SPECIAL = MIN_COEFFICIENT_VALUE_SPECIAL
        self.MAX_COEFFICIENT_VALUE_SPECIAL = MAX_COEFFICIENT_VALUE_SPECIAL
        self.MIN_EQUATIONS_IN_DB = MIN_EQUATIONS_IN_DB
        self.EQUATIONS_TO_PUSH_IN_DB = EQUATIONS_TO_PUSH_IN_DB
